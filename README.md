<h1 align="center">Hi, I'm Ibe Emeka Eric 👋</h1>
<p align="center">
  <strong>Full Stack Developer & Prompt Engineer</strong><br>
  <em>Architecting high-performance web applications & AI-driven workflows.</em>
</p>

<p align="center">
  <a href="mailto:emekaeric12@gmail.com">Email</a> | 
  <a href="https://github.com/eric5509">GitHub</a> | 
...
### Core Development
*   **Frontend:** React, Next.js, TypeScript, JavaScript, Tailwind CSS, SASS[cite: 1].
*   **State Management:** Advanced implementation of **Zustand** and Redux for complex global state management in scalable applications[cite: 1].
*   **Backend:** Node.js, Express.js, Spring Boot, Java, Python[cite: 1].
*   **Database:** PostgreSQL, MongoDB[cite: 1].
*   **Tools & Infrastructure:** Git, Docker, Postman, Webpack, Agile Methodologies[cite: 1].
...
A high-performance web application focused on real-time football data, player statistics, and live match updates.
...
### [Restaurant QR Ordering System](https://github.com/eric5509)
An end-to-end management platform connecting diners and staff via dynamic QR code integration[cite: 1].
*   **Tech Stack:** Next.js 14, TypeScript, Redux, **Zustand**, Spring Boot, WebSockets, PostgreSQL[cite: 1].
*   **Key Achievement:** Utilized WebSockets for real-time order tracking and menu synchronization, achieving a 40% reduction in average order processing time[cite: 1].
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=eric5509&show_icons=true&theme=radical&hide_border=true" alt="Stats" />
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=eric5509&theme=radical&hide_border=true" alt="Streak" />
</p>

---

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=eric5509&label=Profile%20views&color=0e75b6&style=flat" alt="Views" />
</p>
